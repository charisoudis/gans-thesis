...
class SSIM(nn.Module):
    ...
    def forward(self, dataset: Dataset, gen_transforms: Compose, gen: nn.Module, target_index: Optional[int] = None,
...
if __name__ == '__main__':
    ...
    ssim_score = ssim_calculator(_dataset, _gen, target_index=1, condition_indices=(0, 2),
                                 show_progress=True).item()
    print(ssim_score, type(ssim_score))
